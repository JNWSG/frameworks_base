...
public class KeyguardIndicationController {
    ...
    protected final void updateDeviceEntryIndication(boolean animate) {
        ...
        if (mDozing) {
            ...
            if (!TextUtils.isEmpty(mBiometricMessage)) {
                ...
                String batteryTemp = com.android.internal.util.lunaris.ThemeUtils.batteryTemperature(mContext, false);
                String cpuTemp = com.android.internal.util.lunaris.ThemeUtils.getCPUTemp(mContext);
    ...
    protected String computePowerChargingStringIndication() {
        ...
        boolean showbatteryInfo = Settings.Secure.getIntForUser(mContext.getContentResolver(),
            Settings.Secure.LOCKSCREEN_BATTERY_INFO, 1, UserHandle.USER_CURRENT) == 1;
